...
local localleader_mappings = {
  l = {
    ...
    I = { "<cmd>VimtexInfoFull<cr>", "Info Full" },
    t = { "<cmd>VimtexTocOpen<cr>", "TOC Open" },
    T = { "<cmd>Vimtex-TocToggle<cr>", "TOC Toggle" },
    y = { "<cmd>VimtexLabelsOpen<cr>", "Labels Open" },
    Y = { "<cmd>VimtexLabelsToggle<cr>", "Labels Toggle" },
    v = { "<cmd>VimtexView<cr>", "View" },
    r = { "<cmd>VimtexReverseSearch<cr>", "Reverse Search" },
    l = { "<cmd>VimtexCompile<cr>", "Compile" },
    k = { "<cmd>VimtexStop<cr>", "Stop" },
    K = { "<cmd>VimtexStop-all<cr>", "Stop All" },
    ...
    C = { "<cmd>VimtexCleanFull<cr>", "Clean Full" },
